import type { ListTeachersViewType } from "../../types";

export const ListTeachersView = ({
  teachers,
  loading,
  search,
  setSearch,
      ...
      >
        ...
        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
          <button
            ...
            onClick={() =>
              navigate(`/edit-teacher/${teacher.id ?? teacher._id}`)
            }
          >
            <svg
              className="w-5 h-5"
          ...
          <button
            ...
            onClick={() =>
              ...
              requestDelete(String(teacher.id || teacher._id))
            }
          >
            <svg
              className="w-5 h-5"
