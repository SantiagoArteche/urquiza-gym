...
import type { EditTeacherViewType } from "../../types";

export const EditTeacherView = ({
  values,
  errors,
  touched,
  handleChange,
        ...
        >
          ...
          <div className="mt-8">
            <button
              ...
              className="w-full bg-blue-500 hover:bg-blue-600 text-white py-4 px-8 rounded-lg font-semibold text-lg shadow-lg"
            >
              Guardar Cambios
            </button>
          </div>
